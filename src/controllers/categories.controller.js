...
export async function createCategoriesController(req, res, next) {
    try{
...
export async function updateCategoriesController(req, res, next) {
    try{
...
export async function deleteCategoriesController(req, res, next) {
    try{
