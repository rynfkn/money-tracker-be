...
export async function getUserReportsSummaryController (req, res) {
...
export async function getUserReportByCategoryController(req, res) {
    const userId = req.user.id;
...
export async function getUserReportTrendController(req, res) {
    const userId = req.user.id;
